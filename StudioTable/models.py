...
class StudioTable(models.Model):
    ...
    date = models.DateField(unique_for_date = True,  verbose_name = '予約日', null = True)
...
class ReserveTable(models.Model):
    ...
    day_period = models.ForeignKey(StudioTable, on_delete=models.CASCADE, verbose_name = '予約日と時限', null = True, blank = True)
    def __str__(self):
        return self.name